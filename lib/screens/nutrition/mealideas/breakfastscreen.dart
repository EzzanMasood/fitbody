...
import 'package:fitbody/screens/nutrition/mealideas/spinachomelette.dart';
...
class _BreakFastScreenState extends State<BreakFastScreen> {
  bool showSpinachOmelette =false;
  final List<Map<String, String>> trainings = [
    ...
    },
    {
      ...
      "duration": "6 Minutes",
      "calories": "200 Cal",
      "imagePath": "assets/images/mealideas/imgseven.png",
    },
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:showSpinachOmelette
      ? const SpinachOmelette()
      : Column(
        children: [
          SizedBox(height: 20,),
           GestureDetector(
