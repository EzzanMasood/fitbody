...
class KetheBellWorkoutScreen extends StatefulWidget {
  const KetheBellWorkoutScreen({super.key});

  @override
  State<KetheBellWorkoutScreen> createState() => _KetheBellWorkoutScreenState();
}

class _KetheBellWorkoutScreenState extends State<KetheBellWorkoutScreen> {
  @override
                ...
                child: Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/workout/intfour.png', 
                        height: 500,
                        width: double.infinity,
                        fit: BoxFit.cover,
                      ),
