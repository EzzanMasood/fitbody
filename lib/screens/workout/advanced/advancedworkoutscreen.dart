...
import 'package:fitbody/screens/workout/advanced/inclinebenchworkout.dart';
import 'package:flutter/material.dart';

class AdvancedWorkoutScreen extends StatefulWidget {
  const AdvancedWorkoutScreen({super.key});

  @override
  State<AdvancedWorkoutScreen> createState() => _AdvancedWorkoutScreenState();
}

class _AdvancedWorkoutScreenState extends State<AdvancedWorkoutScreen> {
  @override
                    ...
                    Exercise(
                      ...
                      onTap: (context) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const InclineBenchWorkoutScreen(),
                          ),
                        );
                      },
                    ),
