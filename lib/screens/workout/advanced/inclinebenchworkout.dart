...
class InclineBenchWorkoutScreen extends StatefulWidget {
  const InclineBenchWorkoutScreen({super.key});

  @override
  State<InclineBenchWorkoutScreen> createState() => _InclineBenchWorkoutScreenState();
}

class _InclineBenchWorkoutScreenState extends State<InclineBenchWorkoutScreen> {
  @override
                ...
                child: Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/workout/advfour.png', 
                        height: 500,
                        width: double.infinity,
                        fit: BoxFit.cover,
                      ),
